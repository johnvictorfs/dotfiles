...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/AutoSave.nvim"
  },
  LuaSnip = {
  ...
  ["galaxyline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  ["nvim-base16.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/nvim-base16.lua"
  },
  ["nvim-bufferline.lua"] = {
  ...
  ["nvim-compe"] = {
    ...
    after_files = { "/home/john/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
    config = { "\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\18plugins.compe\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/nvim-compe",
    wants = { "LuaSnip" }
  },
  ["nvim-lspconfig"] = {
  ...
  ["nvim-lspinstall"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/nvim-lspinstall"
  },
  ["nvim-tree.lua"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'lspkind-nvim', 'nvim-lspinstall', 'plenary.nvim', 'nvim-treesitter', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
