...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'plenary.nvim', 'lspkind-nvim', 'nvim-lspinstall', 'nvim-colorizer.lua', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
