...
-- OPEN TERMINALS --
map("n", "<C-l>", ":vnew +terminal/usr/bin/zsh | setlocal nobuflisted <CR>", opt) -- term over right
map("n", "<C-x>", ":10new +terminal/usr/bin/zsh | setlocal nobuflisted <CR>", opt) --  term bottom
map("n", "<C-t>t", ":<Cmd> terminal/usr/bin/zsh <CR>", opt) -- term buffer
...
-- Telescope
map("n", "<Leader>sw", ":Telescope live_grep<CR>", opt)
map("n", "<Leader>gst", ":Telescope git_status <CR>", opt)
map("n", "<Leader>gcs", ":Telescope git_commits <CR>", opt)
map("n", "<Leader>sf", ":Telescope find_files <CR>", opt)
